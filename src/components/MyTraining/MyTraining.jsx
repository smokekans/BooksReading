...
import { Button, BooksSelector, Calendar, CalendarContainer, CalendarEndText,  CalendarStartText,  MainTitle, MainTitleContainer, BeginTrainingBtn, BooksContainer, SelectorText, SelectorArrow, SelectorItem, SelectorItemContainer, TableHeaderItem, TableHead, Table, TableString, TableDecoration, TableBodyItem, TableHeader } from './MyTraining.styled';
            ...
            return (
              <tr key={_id} id={_id}>
                <TableDecoration>
                  ...
                  <TableBodyItem>{title}</TableBodyItem>
                  </TableDecoration>
                <td>{author}</td>
                <td>{publishYear}</td>
                <td>{pagesTotal}</td>
