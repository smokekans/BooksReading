...
import { MobileBooksItem, MobileBooksList, MobileBookText, MobileFirstChildContainer, MobileLanguageSwitchBlocks, MobileLanguageSwitchText, MobileTextContainer, Table, TableBodyItem, TableHeader, TableHeaderItem } from "../MyTraining.styled";
...
;
    return (
        <>
            {isMobile ? <MobileBooksList>
                {filter.map(({ _id, title, author, publishYear, pagesTotal }) => {
                    return <MobileBooksItem key={_id} id={_id}>
                        ...
                        <MobileTextContainer>
                            ...
                            <MobileLanguageSwitchText>{langMyTraining.author[lang]}:</MobileLanguageSwitchText>
                            <MobileLanguageSwitchText>{langMyTraining.publishYear[lang]}:</MobileLanguageSwitchText>
                            <MobileLanguageSwitchText>{langMyTraining.pagesTotal[lang]}:</MobileLanguageSwitchText>
                            </MobileLanguageSwitchBlocks>
                            <div>
        ...
        <tbody>
          {filter.map(({ _id, title, author, publishYear, pagesTotal }) => {
            return (
              <tr style={{borderTop:'1px solid #E0E5EB', borderBottom:'1px solid #E0E5EB'}} key={_id} id={_id}>
                <TableBodyItem>
                  <BookIcon style={{ marginRight: "14px" }}/>
                  {title}
                  </TableBodyItem>
          ...
          <tr>
            <td style={{paddingTop: '12px', paddingBottom:'16px'}}><BookIcon style={{ marginRight: "14px" }}/>...</td>
          </tr>
        </tbody>
      </Table>}
        </>
